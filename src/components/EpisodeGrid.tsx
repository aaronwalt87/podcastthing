  ...
  if (episodes.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center">
        ...
        {selectedCategory ? (
          <>
            <p className="text-neutral-400 text-lg font-medium">No episodes in &ldquo;{selectedCategory}&rdquo;</p>
            <p className="text-neutral-600 text-sm mt-2">Try a different category or view all episodes.</p>
          </>
        ) : (
          <>
